...
require('./triggers/medical_triggers.js');
require('./triggers/secretary_triggers.js');
require('./triggers/clinic_triggers.js');
require('./triggers/address_triggers.js');
require('./triggers/cycle_triggers.js');
