...
class _SearchPageState extends State<SecretarySearchView> {
  ...
  final bool _cpfEqualsToBool = false;
  ...
  final _cpfEqualsToTEC = TextEditingController();
          ...
          if (formValid) {
            context
                ...
                .add(SecretarySearchEventFormSubmitted(
                  ...
                  cpfEqualsToBool: _cpfEqualsToBool,
                  cpfEqualsToString: _cpfEqualsToTEC.text,
